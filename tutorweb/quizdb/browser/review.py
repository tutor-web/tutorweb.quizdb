    ...
    def asDict(self):
        ...
        for ugQn in (Session.query(db.UserGeneratedQuestion)
            ...
            out.append(dict(
                ...
                text=ugQn.text,
                choices=[x for x in [
                    dict(answer=ugQn.choice_0_answer, correct=ugQn.choice_0_correct),
                    dict(answer=ugQn.choice_1_answer, correct=ugQn.choice_1_correct),
                    dict(answer=ugQn.choice_2_answer, correct=ugQn.choice_2_correct),
                    dict(answer=ugQn.choice_3_answer, correct=ugQn.choice_3_correct),
                    dict(answer=ugQn.choice_4_answer, correct=ugQn.choice_4_correct),
                    dict(answer=ugQn.choice_5_answer, correct=ugQn.choice_5_correct),
                    dict(answer=ugQn.choice_6_answer, correct=ugQn.choice_6_correct),
                    dict(answer=ugQn.choice_7_answer, correct=ugQn.choice_7_correct),
                    dict(answer=ugQn.choice_8_answer, correct=ugQn.choice_8_correct),
                    dict(answer=ugQn.choice_9_answer, correct=ugQn.choice_9_correct),
